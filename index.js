...
const studyRoutes = require(path.join(__dirname, "routes", "studyRoutes"));
const loginpageRoutes = require(path.join(__dirname, "routes", "loginpageRoutes"));
const youthfarmerregistrationRoutes = require(path.join(__dirname, "routes", "youthfarmerregistrationRoutes"));
const salesagentRoutes = require(path.join(__dirname, "routes", "salesagentRoutes"));
const chickrequestformRoutes = require(path.join(__dirname, "routes", "chickrequestformRoutes"));
const chickstockRoutes = require(path.join(__dirname, "routes", "chickstockRoutes"));
const authRoutes = require(path.join(__dirname, "routes", "AuthRoutes"));
const broodermanagerregistrationRoutes = path.join(__dirname, "routes", "broodermanagerregistrationRoutes");
const broodermanagerdashboardRoutes = path.join(__dirname, "routes", "broodermanagerdashboardRoutes");
...
app.use("/", youthfarmerregistrationRoutes);
...
// const connectEnsureLogin = require('connect-ensure-login');
// const User = require(path.join(__dirname,"models", "UserModel")); // Import User model
...
// const youthfarmerregistrationRoutes = require("./routes/youthfarmerregistrationRoutes");
...
// });
// app.get("/", (req, res) => {
//     res.send('Young4Chicks Server is running successfully!');
// }); 
// app.get('/youthfarmerregistration', (req, res) =>{
//     res.render('youthfarmerregistration'); // Render the registration page
